...
namespace BlueToothLETestWindowsApp
{
	/// <summary>
	...
	sealed partial class App : Application
	{
		...
		private async Task FindAll()
		{
			...
			var k3 = GattServiceUuids.GenericAccess;
			var k1 = GattCharacteristic.ConvertShortIdToUuid( 0x2A00 );
			if ( device != null )
			{
				...
				if ( service != null )
				{
					...
					var characteristic2 = service.GetCharacteristics( GattCharacteristic.ConvertShortIdToUuid( 0x2A01 ) )[0];
					var deviceNameBytes2 = ( await characteristic2.ReadValueAsync() ).Value.ToArray();
					var deviceName2 = Encoding.UTF8.GetString( deviceNameBytes2, 0, deviceNameBytes2.Length );

				}
			}

			devices = await DeviceInformation.FindAllAsync( GattDeviceService.GetDeviceSelectorFromUuid( new Guid( "F000AA10-0451-4000-B000-000000000000" ) ) );
			...
			if ( device != null )
			{
				...
				if ( service != null )
				{
					...
					var accData = service.GetCharacteristics( new Guid( "F000AA11-0451-4000-B000-000000000000" ) )[0];
					...
					var accConfig = service.GetCharacteristics( new Guid( "F000AA12-0451-4000-B000-000000000000" ) )[0];
